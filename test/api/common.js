    ...
    describe('GET /api/getPriceTicker', function() {
        it('should be ok', function(done) {
            getPriceTicker(function(err, res) {
                node.expect(res.body).to.have.property('success').to.be.ok;
                node.expect(res.body).to.have.deep.property('tickers.LWF.BTC').to.be.a.number;
                node.expect(res.body).to.have.deep.property('tickers.LWF.EUR').to.be.a.number;
                node.expect(res.body).to.have.deep.property('tickers.LWF.USD').to.be.a.number;
